...
import { UserInfoItemProps } from '@/app/m/contents/[id]/result/components/Saju/Header/User/types';
import {
  UserInfoItem as Layout,
  SajuInfoButton,
  PreviewSajuSectionLayout,
} from '@/app/m/contents/[id]/result/components/Saju/Header/User/styled';
import DetailInfo from '@/app/m/contents/[id]/result/components/Saju/Header/Detail';
import SajuSection from '@/app/m/contents/[id]/result/components/Saju/Header/Detail/SajuSection';
