...
import { ContentLayout } from '@/app/m/contents/[id]/result/components/Result.styled';
...
import {
  ...
  TarotCard,
  BottomNavigation,
} from '@/app/m/contents/[id]/result/components/Tarot/styled';
import { TarotResultProps } from '@/app/m/contents/[id]/result/components/Tarot/types';
        ...
        >
          {selectedCards.map((card: string) => (
            <SwiperSlide key={card}>
              <ContentLayout>
                <TarotCard
                  cardImg={`${process.env.APP_IMAGE_URL}/m/content/tarot/result/${card}.png`}
                />
              </ContentLayout>
            </SwiperSlide>
          ))}
