...
import { UserInfoItemProps } from '@/app/(pc)/contents/[id]/result/components/Saju/Header/User/types';
import {
  UserInfoItem as Layout,
  SajuInfoButton,
  PreviewSajuSectionLayout,
} from '@/app/(pc)/contents/[id]/result/components/Saju/Header/User/styled';
import DetailInfo from '@/app/(pc)/contents/[id]/result/components/Saju/Header/Detail';
