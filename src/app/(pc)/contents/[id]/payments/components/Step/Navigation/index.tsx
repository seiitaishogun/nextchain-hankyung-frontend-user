...
} from '@/app/(pc)/contents/[id]/payments/components/Step/Navigation/styled';
import { StepNavigationProps } from '@/app/(pc)/contents/[id]/payments/components/Step/Navigation/types';
