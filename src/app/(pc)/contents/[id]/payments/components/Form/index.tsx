...
import FormStep from '@/app/(pc)/contents/[id]/payments/components/Step';
import { PaymentFormProps } from '@/app/(pc)/contents/[id]/payments/components/Form/types';
import {
  mid,
  returnURL,
  ediDate,
} from '@/app/(pc)/contents/[id]/payments/components/Form/constants';
