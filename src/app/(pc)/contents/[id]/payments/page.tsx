...
import { PaddingBox } from '@/app/(pc)/contents/[id]/result/components/Result.styled';
import PaymentForm from '@/app/(pc)/contents/[id]/payments/components/Form';
import { ContentPaymentLayout as Layout } from '@/app/(pc)/contents/[id]/payments/styled';
import ContentHeader from '@/app/(pc)/contents/[id]/result/components/Saju/Header';
import { SampleBox } from '@/app/(pc)/contents/[id]/components/Sample/styled';
