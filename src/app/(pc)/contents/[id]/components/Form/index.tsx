...
import {
  ...
  AgreementLabelBox,
  ButtonLayout,
} from '@/app/(pc)/contents/[id]/components/Form/Form.styled';
import TarotFormContainer from '@/app/(pc)/contents/[id]/components/Form/Tarot';
import SajuFormContainer from '@/app/(pc)/contents/[id]/components/Form/Saju';
import ContentPreview from '@/app/(pc)/contents/[id]/components/Preview';
import Checkbox from '@/app/(pc)/components/Form/Checkbox';
...
function ContentForm({ content }: Props) {
    ...
    switch (content.type.name) {
      case ContentTypeE.Saju:
        return (
          <>
            <ContentPreview />
            <SajuFormContainer isPartner={content.is_partner} />
          </>
        );
  ...
  return (
    <>
      ...
      <AgreementCheck $isCenter={content.type.name === ContentTypeE.Tarot}>
        <AgreementLabelBox>
      ...
      <ButtonLayout
        $isValid={isValid}
        $isCenter={content.type.name === ContentTypeE.Tarot}
      >
