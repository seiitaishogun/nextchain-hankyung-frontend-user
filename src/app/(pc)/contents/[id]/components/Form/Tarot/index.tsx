...
import { MessageBox } from '@/app/(pc)/contents/[id]/components/Form/Form.styled';
import Card from '@/app/(pc)/contents/[id]/components/Form/Tarot/Card';
import TarotForm from '@/app/(pc)/contents/[id]/components/Form/Tarot/Form';
import { CardSection } from '@/app/(pc)/contents/[id]/components/Form/Tarot/styled';
...
function TaroFormContainer({ tarot, maxCardCount, isPartner }: Props) {
